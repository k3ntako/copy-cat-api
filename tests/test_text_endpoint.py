...
class TestPostText:
    def test_post_returns_created_text(self, client):
    ...
    def test_post_commits_to_db(self, app, client):
    ...
    def test_post_rejects_request_without_json_body(self, client):
    ...
    def test_post_rejects_request_without_text_string_parameter(self, client):
    ...
    def test_post_rejects_only_whitespace(self, client):
    ...
    def test_post_only_allows_strings(self, client):
    ...
    def test_post_validates_length(self, client):
...
class TestGetTexts:
    def test_get_returns_empty_array_when_no_texts_in_db(self, client):
    ...
    def test_get_returns_text_from_database(self, client, texts):
    ...
    def test_get_returns_multiple_texts_from_database(self, client, texts):
    ...
    def test_get_returns_10_texts_from_database(self, client, texts):
